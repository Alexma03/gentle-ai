...
func SetupAgentSlug(agent model.AgentID) (string, bool) {
	...
	case model.AgentAntigravity:
		// Antigravity receives its MCP and ~/.gemini/GEMINI.md projections
		// directly; engram has no native Antigravity setup slug.
		return "", false
	case model.AgentCursor:
		// Cursor does not use `engram setup` — its MCP
