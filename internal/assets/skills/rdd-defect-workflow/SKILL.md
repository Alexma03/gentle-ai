...
- Assess review workload before edits using causal cohesion, architecture and domain boundaries, interface breadth, risk, verification burden, rollback independence, and reviewer cognitive load. Chain only at natural boundaries; never use line counts or size waivers.
