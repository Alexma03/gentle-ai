...
func TestGeneratedOrchestrationEntryCarriesTheBoundPiContract(t *testing.T) {
	...
	if !strings.Contains(text, "## Atomic lifecycle") {
		t.Fatal("orchestration/pi.md is missing the personal fork's `## Atomic lifecycle` heading")
	}
}
